...
class Profiler extends EventEmitter {
	...
	constructor(namespace) {
		...
		this.disabledBlock = new ProfilerBlock({ id: -1, name: 'DISABLED', profiler: this, isActive: false });
	 ...
	 */
		...
		if (typeof block === 'number') return this.activeBlocksById[block].end();
		if (typeof block === 'string') return this.activeBlocksByName[block].end();
		if (typeof block !== 'object') return block.end();
	}
